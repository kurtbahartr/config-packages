...
# Spotify
sudo wget -O /etc/apt/sources.list.d/spotify.sources https://github.com/kurtbahartr/config-rootfs/raw/master/common-deb/etc/apt/sources.list.d/spotify.sources
