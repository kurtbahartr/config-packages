...
sudo gpg --keyring /etc/apt/trusted.gpg.d/ppa-telegram.gpg adv --keyserver keyserver.ubuntu.com --recv-key 25402D509B042DD9
sudo gpg --keyring /etc/apt/trusted.gpg.d/ppa-telegram.gpg adv --keyserver keyserver.ubuntu.com --recv-key 6A9653F936FD5529
